...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-288-erd-s-problem-288-c6ecada0-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-288"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-288-erd-s-problem-288-c6ecada0-v1",
      "problem_contract_sha256": "74a58bdf185f112a423a59e0fe8dbe5a2f52a22835a0710be442a7d73da9bf5e",
      "problem_id": "problem:um-ep-288-erd-s-problem-288-c6ecada0",
      "route_id": "route:um-ep-288-erd-s-problem-288-c6ecada0-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-288-erd-s-problem-288-c6ecada0-source-fidelity-01",
      "graph_id": "graph:um-ep-288-erd-s-problem-288-c6ecada0-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-288-erd-s-problem-288-c6ecada0-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-288-erd-s-problem-288-c6ecada0-root",
          "statement": {
          ...
          "statement_sha256": "737fc6850ce57c019cbde3fd1a7e6bd5463c710db32175ab8884ba69fff15f10"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-288-erd-s-problem-288-c6ecada0-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-288-erd-s-problem-288-c6ecada0-root",
      "route_id": "route:um-ep-288-erd-s-problem-288-c6ecada0-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-288-5aab7de11274",
        "url": "https://www.unsolvedmath.com/problems/EP-288"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
